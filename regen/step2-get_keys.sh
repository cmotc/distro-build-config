#! /bin/sh
echo "##Getting the Supplemental Repository Keys"
echo "###Downloading the Tor repository keys"
...
echo "###Downloading the i2p repository keys"
...
echo "###Downloading the namecoin repository keys"
...
echo "###Downloading the Tox.im repository keys"
torsocks wget https://pkg.tox.chat/debian/pkg.gpg.key -O config/archives/toxim.list.key.chroot
#cp config/archives/toxim.list.key.chroot config/archives/toxim.list.key.binary

echo "###Downloading the Fireaxe repository keys"
torsocks wget -qO - https://cmotc.github.io/apt-git/cmotc.github.io.gpg.key -O config/archives/cmotc.github.io.gpg.key.chroot
#echo "###Downloading the Twister repository keys"
