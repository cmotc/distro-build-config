#! /bin/sh
mkdir -p config/includes.bootstrap/usr/lib/apt/methods
cp -p /usr/lib/apt/methods/https config/includes.bootstrap/usr/lib/apt/methods/https
ls -la config/includes.bootstrap/usr/lib/apt/methods
mkdir -p config/includes.bootstrap/usr/share/doc/apt-transport-https
cp -p /usr/share/doc/apt-transport-https/NEWS.Debian.gz config/includes.bootstrap/usr/share/doc/apt-transport-https/NEWS.Debian.gz
cp -p /usr/share/doc/apt-transport-https/apt-transport-https.README config/includes.bootstrap/usr/share/doc/apt-transport-https/apt-transport-https.README
cp -p /usr/share/doc/apt-transport-https/changelog.gz config/includes.bootstrap/usr/share/doc/apt-transport-https/changelog.gz
cp -p /usr/share/doc/apt-transport-https/copyright config/includes.bootstrap/usr/share/doc/apt-transport-https/copyright
